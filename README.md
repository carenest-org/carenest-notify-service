# CareNest Notify Service

Notification management microservice for the CareNest healthcare platform.
...
```
jayadevarun2003/carenest-notify-service:latest
jayadevarun2003/carenest-notify-service:sha-abc1234
jayadevarun2003/carenest-notify-service:v1.2.0     ← only when git tag exists
```
...
```bash
# Build locally
docker build -t carenest-notify-service .

# Run locally
docker run -p 3004:3004 --env-file .env carenest-notify-service
```
...
# sonarqube ip update Sat Apr 25 18:59:08 UTC 2026
